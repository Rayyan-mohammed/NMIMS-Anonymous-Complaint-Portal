...
<body>
    ...
    <div class="admin-container">
        <h1>Admin Portal</h1>
        <a href="login_program_chair.php" class="btn">Program Chair Login</a>
        <a href="login_deputy_registrar.php" class="btn">Deputy Registrar Login</a>
        <a href="login_campus_director.php" class="btn">Campus Director Login</a>
        <a href="login_hostel_rector.php" class="btn">Hostel Rector Login</a>
    </div>
