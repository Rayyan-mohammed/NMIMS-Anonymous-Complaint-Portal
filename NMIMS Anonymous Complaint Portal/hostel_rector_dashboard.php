...
<body>
    ...
    <div class="container">
        <h1>Hostel Rector Dashboard</h1>

        <!-- Hostel Complaints Section -->
        <div class="section" id="hostelComplaints">
            <h2 class="section-title">Hostel Complaints</h2>
            <div class="table-container">
                ...
                $sql = "SELECT reference_number, complaint_details, status, submitted_at, comment FROM hostel_complaints";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><textarea class='comment-textarea' data-ref='" . $row['reference_number'] . "' data-table='hostel_complaints' data-database='$database'>" . htmlspecialchars($row['comment'] ?? '') . "</textarea></td>";
                        echo "<td>" . $row['submitted_at'] . "</td>";
                        echo "<td>";
                        echo "<select onchange=\"updateStatus('hostel_complaints', '" . $row['reference_number'] . "', this.value, '$database')\">";
                    ...
                    echo "<p>No hostel complaints found.</p>";
                }
                $conn->close();
                ?>
            </div>
