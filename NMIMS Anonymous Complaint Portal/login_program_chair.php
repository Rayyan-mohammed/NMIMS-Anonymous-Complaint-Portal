...
<head>
    ...
    <title>Program Chair Login</title>
    <style>
    ...
    <div class="login-container">
        ...
        <form method="POST" action="">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (isset($validPasswords[$school]) && $password === $validPasswords[$school]) {
                    // Redirect to the dashboard
                    header("Location: program_chair_dashboard_$school.php");
                    exit(); // Ensure no further code is executed after redirect
                } else {
                    echo "<p>Invalid school or password!</p>";
                }
            }
            ?>
        </form>
    ...
    <script>
        ...
        window.addEventListener('load', () => {
            ...
            if (!isPostRequest) {
                ...
                // If it's a POST request, hide the loader immediately to allow redirect
                document.getElementById('loader').classList.add('hidden');
            }
        });
